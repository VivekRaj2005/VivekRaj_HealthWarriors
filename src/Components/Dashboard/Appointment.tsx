        ...
        <div className="container px-5 pb-24 pt-5 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left border-dotted border-[5px] p-2 cursor-pointer hover:border-solid hover:border-indigo-700 transition-all duration-300 cursor-pointer hover:border-solid hover:border-indigo-700 transition-all duration-300">
                <img
                  alt="team"
            ...
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left border-dotted border-[5px] p-2 cursor-pointer hover:border-solid hover:border-indigo-700 transition-all duration-300">
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4"
                  src={DrRajesh}
                ...
                <div className="flex-grow sm:pl-8">
                  ...
                  <p className="mb-4">
                    ...
                    department of Internal Medicine. He has been practicing for
                    more than 25yrs
                  </p>
                  <span className="inline-flex">
                    <a className="text-gray-500">
            ...
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left border-dotted border-[5px] p-2 cursor-pointer hover:border-solid hover:border-indigo-700 transition-all duration-300">
                ...
                <div className="flex-grow sm:pl-8">
                  ...
                  <p className="mb-4">
                    Dr. Lawanya is a skilled diabetologist, specializing in the
